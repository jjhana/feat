 ...
 *
 * Based on Ilya Sherman's Generics class in Stanford tagger.
 *
 * Only 3rd party collections (esp. java.util) should be handled here, our own
 * collections should provide newx static factory method(s).
 *
 */
public class XCols {

  private XCols() {} // static class
  ...
  public static <E> ArrayList<E> newArrayList(E ... c) {
...
//  }
  ...
  public static <K,V> MultiMap<K,V> newMultiHashHashMap() {
    return new MultiHashHashMap<K,V>();
  }
