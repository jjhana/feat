...
public class BLayerDataObject extends LLayerDataObject {

    public BLayerDataObject(FileObject pf, MultiFileLoader loader) throws DataObjectExistsException, IOException {
        super(pf, loader);
    }
